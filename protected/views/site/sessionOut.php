...
<body>        
        <div style="height:100%;width:100%">   
            <div style="margin:0 auto;position:relative; top: 20%" align='center'>
                <img src="<?php echo Yii::app()->theme->baseUrl?>/images/logoExSmall.png" alt="">   
                <p style='padding-top:20px;font-size:18px;padding-bottom:10px;font-family:Lato'>Your session is out. You will be redirected to login page.</p>
                <?php echo CHtml::encode($message); ?>
                <p style="color: #404040;padding-top:20px;font-family: Lato" id="lblCount">Redirecting in 10 sec.</p>
            </div>
