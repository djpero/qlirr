    <!DOCTYPE html>
<?php
    $shop          = ShopsDao::getShopById($_GET['id']);
    $shopAddress   = ShopAddressDao::getPrimaryAddressByShopId($shop->id);
    $shopAddress2  = ShopAddressDao::getLegalAddressByShopId($shop->id);
...
<body>
    ...
    <input id="inputShop" value="<?php echo $shop->id; ?>" hidden />    
...
<div class="wrapper">
  ...
  <div class="page-content">
    <div class="content container">
      <div class="row">
       <div class="col-lg-12">
            <div class="col-lg-6"><h2 class="page-title">Shop Details</h2></div>
        ...
        <div class="col-lg-9">
          <div class="widget">
            <div class="widget-header"> <i class="icon-user"></i>
              <h3><?php echo 'Shop #'.$shop->id.' - <span style="font-weight:900">'.$shop->name.'</span>';  ?></h3>
            </div>
              ...
              <div class="tab-content" id="myTabContent">
                <div id="basic" class="tab-pane fade active in">
                    <table style="width:70%;margin-top:30px;">
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                            <td colspan="2" style="color: #eee;font-weight:700;font-size:16px;">Account information</td>
                            <td></td>
                        </tr>
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                          <td  style="color: #d8d6d6; border-right: 1px dotted aliceblue">Class of trade:</td>
                          <td style="font-weight: bold; padding-left:4px"><?php 
                            $shopType = ShopTypeDao::getShopType($shop->shop_type_id);
                            echo $shopType->name; ?></td> 
                          <td></td>
                        </tr>
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                          <td  style="color: #d8d6d6; border-right: 1px dotted aliceblue">Shop Client ID:</td>
                          <td style="font-weight: bold; padding-left:4px"><?php echo $shop->shop_id; ?></td> 
                          <td></td>
                        </tr>
                        
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                          <td  style="color: #d8d6d6; border-right: 1px dotted aliceblue">Address:</td>
                          <td style="font-weight: bold; padding-left:4px"><?php echo $shopAddress->street.', '.$shopAddress->post_code.' '.$shopAddress->city; ?></td> 
                          <td></td>
                        </tr>
                        
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                          <td style="color: #d8d6d6; border-right: 1px dotted aliceblue">Signed/end:</td>
                          <td style="font-weight: bold; padding-left:4px"><?php echo $shop->date_signed.' / '.$shop->date_signed_end; ?></td> 
                          <td></td>
                        </tr>
                        <tr>
                            <td colspan="3">&nbsp;</td>
                        ...
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                            <td colspan="2" style="color: #eee;font-weight:700;font-size:16px;">Login information</td>
                            <td></td>
                        </tr>
                        
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                          <td  style="color: #d8d6d6; border-right: 1px dotted aliceblue">User name:</td>
                          <td style="font-weight: bold; padding-left:4px"><?php echo $shop->username; ?></td> 
                          <td></td>
                        </tr>
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                          <td  style="color: #d8d6d6; border-right: 1px dotted aliceblue">Password:</td>
                          <td style="font-weight: bold; padding-left:4px">Change password</td> 
                          <td></td>
                        </tr>
                        <tr>
                            <td colspan="3">&nbsp;</td>
                        ...
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                            <td colspan="2" style="color: #eee;font-weight:700;font-size:16px;">Bank information</td>
                            <td></td>
                        </tr>   
                        
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                          <td style="color: #d8d6d6; border-right: 1px dotted aliceblue">Bank:</td>
                          <td style="font-weight: bold; padding-left:4px"><?php 
                          $shopBank = ShopBankDao::getBankByUserId($shop->id);
                          $banks = BanksDao::getBankName($shopBank->bank_id);
                          echo $banks->full_name;        
                                  ?></td> 
                          <td></td>
                        </tr>
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                          <td style="color: #d8d6d6; border-right: 1px dotted aliceblue">Bank clearing/account:</td>
                          <td style="font-weight: bold; padding-left:4px"><?php echo $shop->bank_clearing.' / '.$shop->bank_account; ?></td> 
                          <td></td>
                        </tr>
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                          <td style="color: #d8d6d6; border-right: 1px dotted aliceblue">Bank Swift/IBAN:</td>
                          <td style="font-weight: bold; padding-left:4px"><?php echo $shop->bank_swift.' / '.$shop->bank_iban; ?></td> 
                          <td></td>
                        </tr>
                        ...
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                            <td colspan="2" style="color: #eee;font-weight:700;font-size:16px;">Company information</td>
                            <td></td>
                        </tr> 
                        
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                          <td  style="color: #d8d6d6; border-right: 1px dotted aliceblue">Legal name:</td>
                          <td style="font-weight: bold; padding-left:4px"><?php echo $shop->company_name; ?></td> 
                          <td></td>
                        </tr>
                        
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                          <td  style="color: #d8d6d6; border-right: 1px dotted aliceblue">Address:</td>
                          <td style="font-weight: bold; padding-left:4px"><?php echo $shopAddress2->street.', '.$shopAddress2->post_code.' '.$shopAddress2->city; ?></td> 
                          <td></td>
                        </tr>
                         <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                          <td style="color: #d8d6d6; border-right: 1px dotted aliceblue">VAT number:</td>
                          <td style="font-weight: bold; padding-left:4px"><?php echo $shop->vat_number; ?></td> 
                          <td></td>
                        </tr>
                        
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                          <td style="color: #d8d6d6; border-right: 1px dotted aliceblue">Owner:</td>
                          <td style="font-weight: bold; padding-left:4px"><?php echo $shop->owner1; ?></td> 
                          <td></td>
                        </tr>
                        
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                          <td style="color: #d8d6d6; border-right: 1px dotted aliceblue">Personal number:</td>
                          <td style="font-weight: bold; padding-left:4px"><?php echo $shop->ssn; ?></td> 
                          <td></td>
                        </tr>
                        
                           <?php
                            $shopCompany = ShopsCompanyDao::getAllOwners($shop->id);
   
                            if (count($shopCompany)>0) {
                                $x=0;
                                do {
                                    $up  = '<tr style="height:'.$tableHeight.'px; border-bottom:1px dotted grey;">
                                            <td style="color: #d8d6d6; border-right: 1px dotted aliceblue">Owner #'.($x+2).':</td> 
                                            <td style="font-weight: bold; padding-left:4px">'.$shopCompany[$x]->owner.'</td><td></td></tr>';
                                    $down = '<tr style="height:'.$tableHeight.'px; border-bottom:1px dotted grey;">
                                            <td style="color: #d8d6d6; border-right: 1px dotted aliceblue">Personal number #'.($x+2).':</td>
                                            <td style="font-weight: bold; padding-left:4px">'.$shopCompany[$x]->ssn.'</td><td></td></tr>';
                                    echo $up.$down;
                                    $x++;
                                } while ($x<count($shopCompany));
                            }
                        ?>
                        ...
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                            <td colspan="2" style="color: #eee;font-weight:700;font-size:16px;">Contact information</td>
                            <td></td>
                        </tr> 
                        
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                          <td style="color: #d8d6d6; border-right: 1px dotted aliceblue">Contact person:</td>
                          <td style="font-weight: bold; padding-left:4px"><?php echo $shop->contact ?></td> 
                          <td></td>
                        </tr>
                          
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                          <td style="color: #d8d6d6; border-right: 1px dotted aliceblue">Email:</td>
                          <td style="font-weight: bold; padding-left:4px"><?php echo $shop->email; ?></td> 
                          <td></td>
                        </tr>
                        
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                          <td style="color: #d8d6d6; border-right: 1px dotted aliceblue">Mobile:</td>
                          <td style="font-weight: bold; padding-left:4px"><?php echo $shop->mobile_number ?></td> 
                          <td></td>
                        </tr>
                        <?php
                            ...
                            if (count($shopContacts)>0) {
                                ...
                                do {
                                    $up  = '<tr style="height:'.$tableHeight.'px; border-bottom:1px dotted grey;">
                                            <td style="color: #d8d6d6; border-right: 1px dotted aliceblue">Email #'.($x+2).':</td> 
                                            <td style="font-weight: bold; padding-left:4px">'.$shopContacts[$x]->email.'</td><td></td></tr>';
                                    $down = '<tr style="height:'.$tableHeight.'px; border-bottom:1px dotted grey;">
                                            <td style="color: #d8d6d6; border-right: 1px dotted aliceblue">Mobile #'.($x+2).':</td>
                                            <td style="font-weight: bold; padding-left:4px">'.$shopContacts[$x]->phone.'</td><td></td></tr>';
                                    echo $up.$down;
                                    $x++;
                        ...
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                            <td colspan="2" style="color: #eee;font-weight:700;font-size:16px;">Services</td>
                            <td></td>
                        </tr> 
                        
                        <tr style="height: <?php echo $tableHeight.'px' ?>; border-bottom:1px dotted grey;">
                          <td style="color: #d8d6d6; border-right: 1px dotted aliceblue">Services:</td>
                          <td style="font-weight: bold; padding-left:4px"><?php 
                    ...
                    <div id="demo">
                      <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                        ...
                        <tbody>
                            ...
                            <?php
                            $x=0;
                            $orders = OrdersDao::getSalesByUser($shop->id);

                            while ($x < count($orders))  
                              {
                                  $buyerId = UsersDao::getUserById($orders[$x]->buyer_id);
                                  ...
                                  echo '<tr class="gradeA">'.
                                       ...
                                       '<td class="hidden-xs">'.$orderStatus->name.'</td></tr>';
                ...
                <div id="finance" class="tab-pane fade">
                    ...
                    <div id="container">
                        ...
                        <thead>
                            <tr>
                                <th class="hidden-xs">Document ID</th>
                                <th class="hidden-xs">Date</th>
                                <th class="hidden-xs">Total Amount</th>
                                <th class="hidden-xs">Transaction count</th>
                        ...
                        <tbody>
                            ...
                            <?php
                            $y=0;
                            $invoice = InvoiceDao::getInvoicesByShop($shop->id);

                            while ($y < count($invoice))  
                              {
                                echo '<tr class="gradeA">'.
                                     '<td class="hidden-xs" style="cursor:pointer"><a  onclick="viewInvoice('.$invoice[$y]->id.');">'.$invoice[$y]->id.'</a></td>'.
                                     '<td class="hidden-xs" style="cursor:pointer"><a  onclick="viewInvoice('.$invoice[$y]->id.');">'.$invoice[$y]->time_created.'</a></td>'.
                                     '<td class="hidden-xs" style="cursor:pointer"><a  onclick="viewInvoice('.$invoice[$y]->id.');">'.$invoice[$y]->total_amount.'</a></td>'.
                                     '<td class="hidden-xs" style="cursor:pointer"><a  onclick="viewInvoice('.$invoice[$y]->id.');">'.$invoice[$y]->count.'</a></td>'.
                                     '<td class="hidden-xs"><a href="/user/orders/downloadInvoice/id/'.$invoice[$y]->id.'" style="font-size:16px"><i class="fa fa-download"></i> <span style="font-size:12px">Fee</span></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/user/orders/downloadInvoiceList/id/'.$invoice[$y]->id.'" style="font-size:16px"><i class="fa fa-download"></i> <span style="font-size:12px">List</span></a></td></tr>'.
                                $y++;
                              }
                            ?>
                          </tbody>
                ...
                <div id="upload" class="tab-pane fade">
                    <div style="background-color:rgba(255,255,255,0.2);border-radius: 4px;border:none;height: content-box">
                        <p style="font-weight:900;padding-left:8px;padding-top:4px;padding-bottom:4px;text-shadow: 0px 0px 2px #000;background-color: rgba(0,255,60,0.5)"><i class="fa fa-cloud-upload" style="padding-right:4px;font-size:18px;vertical-align: -2px"></i> Files list</p>
                        
                        <?php
                        
                            $w=0;
                            $output='';
                            $fileList = FilesDao::getFilesListByCID($shop->shop_id);
                            $divHeader = '<div class="file_document" align="center">';
                            $divFooter = '</div></a>';
                            if (count($fileList)>0) {
                            
                                do {

                                    $fileUrl = Yii::app()->assetManager->publish($fileList[$w]->real_name);                                
                                    $link = '<a href="'.$fileUrl.'" target="_blank">';
                                    $list = '<p>'.$fileList[$w]->name.'</p>';
                                    // ----------------------------------------------
                                        $ext = explode(".",$fileList[$w]->name);

                                        if (strtolower($ext[1])=='jpg' || strtolower($ext[1])=='png') {
                                               $extPic = 'fa-file-image-o';
                                        } elseif(strtolower($ext[1])=='pdf')  {
                                               $extPic = 'fa-file-pdf-o'; 
                                        } else {
                                             $extPic = 'fa-file'; 
                                        }
                                    // ----------------------------------------------
                                    $ipic = '<i class="fa '.$extPic.'"></i>';
                                    $output = $output.$link.$divHeader.$ipic.$list.$divFooter;
                                    $w++;
                                } while ($w < count($fileList));
                                echo $output;
                            }
                        ?>
                        ...
                        <div>
                            <iframe id="upload2" src="/admin/default/uploadS/data/<?php echo $shop->shop_id;  ?>"  style="border-top: 1px dotted white;padding-top:10px;width:100%">
                ...
                <div id="comments" class="tab-pane fade">
                   ...
                   <?php  
                         $x=0;
                         $comments = ShopCommentsDao::getAllCommentsByShopId($shop->id);
    ...
    <div  aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" class="modal fade" id="cancelOfferModal">
        ...
        <!-- /.modal-dialog --> 
         ...
         <div id="invoicesInfo" style="position:fixed;left:0;top:0;width:100%;height:100%;background-color: rgba(0,0,0,0.7);z-index:9999" hidden>
             <div class="row">
                <div style="position:relative;background-color:white;left:30%;width:40%;top:200px;border-radius: 3px;box-shadow: 0px 0px 11px 0px rgba(50, 50, 50, 0.75);">
                    <div class="row-fluid" style="margin:10px">
                        <p style="font-size:22px;padding-top: 12px;font-weight: 300">Invoice <span id="invoiceID" style="font-weight:900"> </span></p>
                        <div id="invoiceContent" style="margin-top:14px;" align="center">
                            
                        </div>
                        <div style="padding-bottom:10px;border-top:1px solid #ddd;padding-top:8px" align="right">
                            <p class="btn btn-small btn-danger" onclick="closeInvoiceInfo();">Close</p>
                        </div>
                    </div>
                </div>
             </div>
...
<script type="text/javascript" language="javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/themes/admin/js/jquery.filedrop.js"></script>
<script type="text/javascript" language="javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/themes/admin/js/script.js"></script>
<script src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script>

<script type="text/javascript" charset="utf-8">
    
//    $('#invoicesInfo').click(function(){
//       $(this).fadeOut(200); 
//    });
    function closeInvoiceInfo() {
       $('#invoicesInfo').fadeOut(200);
    }
    
    function viewInvoice(id) {
        
        $.ajax({
                 url: "/admin/default/viewInvoice",
                 type: "post",
                 dataType: 'html',
                 data: "data="+id,
...
//              $('#inputNumber').attr('style','border-color:aquablue');
    ...
    function saveNewComment() {
        ...
        var c = document.getElementById("inputShop").value;
        
        $.ajax({
                 url: "/admin/default/saveNewCommentShop",
                 type: "post",
                 dataType: 'html',
                 data: "data="+a+"|"+b+"|"+c,
                 success: function(data){
