...
<?php
     $orderStatus = OrderStatusFDao::getAllStatuses('1');
?>
<html>
<head>
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
      <thead>
            <tr>
                ...
                <th class="hidden-xs" style="width:160px" >Payment reference</th>
                ...
                <th class="hidden-xs" style="width:160px">Date accepted</th>
                <th class="hidden-xs" style="width:160px">Due date</th>
                <th class="hidden-xs" style="width:60px">Action</th>
            </tr>
        </thead>
...
<script type="text/javascript" charset="utf-8">
    ...
    function getTableData() {
        ...
        $.ajax({
            url: "/admin/default/getOrdersTableDataF",
            type: "post",
            dataType: 'html',
            data: "data="+optionId,
   ...
   function changeToCourt(id) {

       
      $.ajax({
            url: "/admin/default/changeFinancialStatus",
            type: "post",
            dataType: 'html',
            data: "data="+id,
            success: function(data){
