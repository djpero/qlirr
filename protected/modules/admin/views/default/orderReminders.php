  ...
  <div id="demo">
      <div style="padding:20px; margin-bottom: 20px;background: rgba(0,0,0,0.2 ); border-radius: 6px;">
            ...
            <select id="reminderSel" class="selectpicker" style="margin:5px;width:120px;height:30px;background-color: rgba(0,0,0,0.2);color:white;border:none">
                <?php   
                    $x=0;
                    while ($x < count($reminderStatus))  {
                        echo '<option id="'.$reminderStatus[$x]->id.'" value="'.$reminderStatus[$x]->id.'">'.$reminderStatus[$x]->name2.'</option>';
                        $x++;
                    }
                ?>
            </select>
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
      <thead>
            <tr>
                ...
                <th class="hidden-xs" style="width:180px">Reminder amount</th>
                <th class="hidden-xs" style="width:140px" >Total amount</th>
...
<script type="text/javascript" charset="utf-8">
    ...
    function getTableData() {
        ...
        $.ajax({
            url: "/admin/default/getRemindersTableData",
            type: "post",
            dataType: 'html',
            data: "data="+optionId,
