    ...
    class ESmartyViewRenderer extends CApplicationComponent implements IViewRenderer
    {
        ...
        */
        public function init(){
            ...
            $this->smarty->setTemplateDir(yii::getPathOfAlias($this->tpl_directory));

            $compileDir = yii::getPathOfAlias($this->config['compile_dir']);

            $compileDir = isset($compileDir) ?
