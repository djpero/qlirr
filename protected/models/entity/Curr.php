...
/**
 * This is the model class for table "curr".
 *
 * The followings are the available columns in table 'curr':
 ...
 */
class Curr extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Curr the static model class
	 */
