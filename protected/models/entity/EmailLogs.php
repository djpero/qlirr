    ...
    class EmailLogs extends CActiveRecord
    {
        ...
        */
        public function rules()
        {
            ...
            return array(
                array('user_id, email, subject, content, sender_email, code', 'required'),
                array('user_id, code', 'length', 'max'=>10),
                array('email, subject, sender_email', 'length', 'max'=>100),
                // The following rule is used by search().
                // Please remove those attributes that should not be searched.
                array('id, user_id, email, subject, content, sender_email, code, created_time', 'safe', 'on'=>'search'),
            );
        }
