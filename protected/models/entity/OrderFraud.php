...
class OrderFraud extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, order_id, message, notify', 'required'),
			array('id, order_id, notify', 'numerical', 'integerOnly'=>true),
			array('time_created', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, order_id, message, notify, time_created', 'safe', 'on'=>'search'),
		);
	}
