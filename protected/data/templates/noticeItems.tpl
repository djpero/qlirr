                                ...
                                <td style="padding" height="70px">
                                    <table cellpadding="4px" class="blackBD">
                                        ...
                                        <tr>
                                            ...
                                            <td class="wb">{$order.total_amount} HRK</td>
                                        </tr>
                    ...
                    <td height="190px">
                        ...
                        <table class="tr" width="660px">
                            ...
                            <tr>
                                ...
                                <td>Ugovor broj {$order.id}</td>

                                <td></td>
                                <td class="txtRight">{$order.total_amount}</td>
                            </tr>
                            <tr>
                                <td colspan="5"></td>        
                            </tr>
                            <tr>
                                ...
                                <td></td>
                                <td></td>        
                                <td class="txtRight"><b>{$order.total_amount}</b></td>
                            </tr>
                        </table>
        ...
        <td id="sndCell" height="330px" >
            ...
            <table class="bgY" cellpadding="2px" cellspacing="0">
                ...
                <tr height="20px">        
                    ...
                    <td width="177px">
                        <table width="170px">
                            <tr><td height="22px">{$order->total_amount} HRK</td></tr>
                            <tr>                    
