<?php /* Smarty version Smarty-3.1.13, created on 2013-08-02 15:16:45
         compiled from "/ws/prod/peydo/code/protected/data/templates/noticeItems.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13171496251fbb13d491954-84667629%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9ca3b8080d7a300bb42e3e65fe7d8c291c53df05' => 
    array (
      0 => '/ws/prod/peydo/code/protected/data/templates/noticeItems.tpl',
      1 => 1374264087,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13171496251fbb13d491954-84667629',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_51fbb13d4e8f53_69595414',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51fbb13d4e8f53_69595414')) {function content_51fbb13d4e8f53_69595414($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/ws/prod/peydo/code/protected/vendors/smarty/plugins/modifier.date_format.php';
?><style>
                                ...
                                <td style="padding" height="70px">
                                    <table cellpadding="4px" class="blackBD">
                                        ...
                                        <tr>
                                            ...
                                            <td class="wb"><?php echo $_smarty_tpl->tpl_vars['order']->value['total_amount'];?>
 HRK</td>
                                        </tr>
                    ...
                    <td height="190px">
                        ...
                        <table class="tr" width="660px">
                            ...
                            <tr>
                                ...
                                <td>Ugovor broj <?php echo $_smarty_tpl->tpl_vars['order']->value['id'];?>
</td>

                                <td></td>
                                <td class="txtRight"><?php echo $_smarty_tpl->tpl_vars['order']->value['total_amount'];?>
</td>
                            </tr>
                            <tr>
                                <td colspan="5"></td>        
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td></td>        
                                <td class="txtRight"><b><?php echo $_smarty_tpl->tpl_vars['order']->value['total_amount'];?>
</b></td>
                            </tr>
                        </table>
            ...
            <table class="tr" width="660px">
                ...
                <tr>
                    ...
                    <td width="160px">Primatelj plaćanja<br/>
                        ...
                        Privredna Banka Zagreb d.d. 2340009-1110424605</td>
                </tr>    
            </table>
...
, <?php echo $_smarty_tpl->tpl_vars['customerCity']->value;?>
                    ...
                    <td width="177px">
                        <table width="170px">
                            <tr><td height="22px"><?php echo $_smarty_tpl->tpl_vars['order']->value->total_amount;?>
 HRK</td></tr>
                            <tr>                    
